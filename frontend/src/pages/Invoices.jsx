      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <PermissionGuard permission="invoices.create">
          <button
            ...
            className="group flex items-center justify-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-700 hover:from-indigo-700 hover:to-purple-800 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl font-semibold transition-all duration-300 shadow-lg shadow-indigo-600/30 hover:shadow-xl hover:shadow-indigo-600/40 hover:scale-105 text-sm sm:text-base w-full md:w-auto"
          >
            <Plus
              size={18}
    ...
    >
      ...
      <div className="relative flex items-center gap-3 sm:gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-500 font-semibold uppercase tracking-wider mt-0.5">
            {label}
          </p>
        </div>
      </div>
