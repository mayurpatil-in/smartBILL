    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 md:gap-4 flex-wrap justify-center">
          ...
          {/* Session Timer */}
          <div className="px-3 py-1 rounded-lg bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border border-blue-100 dark:border-blue-900/30">
            <SessionTimer />
          </div>
          ...
          {/* Version */}
          <div className="px-3 py-1 rounded-lg bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-900 dark:to-blue-900/20 border border-gray-200 dark:border-gray-700">
