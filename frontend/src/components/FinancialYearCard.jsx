          ...
          <div className="flex items-start justify-between mb-6">
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                <div className="relative p-4 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-2xl shadow-xl">
            ...
            <div className="px-5 py-2.5 rounded-2xl text-sm font-black flex items-center gap-2 shadow-xl backdrop-blur-sm border-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white border-green-300 dark:border-green-700 shadow-green-500/30">
          ...
          <div className="mt-4 flex items-center gap-2">
            {!fy.is_locked ? (
              <>
                ...
                <button
                  onClick={onAddFY}
                  className="flex-1 px-4 py-2 text-xs font-bold rounded-lg bg-gradient-to-r from-blue-500 to-cyan-600 text-white hover:from-blue-600 hover:to-cyan-700 shadow-md shadow-blue-500/30 hover:shadow-lg hover:shadow-blue-500/40 transition-all duration-300 flex items-center justify-center gap-1.5"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
                  ...
                  <span>Change Financial Year</span>
                </button>
              </>
            ) : (
